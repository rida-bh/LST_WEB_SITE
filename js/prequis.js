...
function replace_element(i,n){
    ...
    let button1=divi.lastElementChild;
	button1.style.display="none";
    divi.appendChild(new_element);
    let button2=document.createElement("button");
    button2.textContent="Moins du detail";
    button2.setAttribute("onclick","remove("+i+")");
	button2.style.marginTop = "20px";
    button2.classList=button1.classList;
    divi.appendChild(button2);
}
function remove(i){
    let divi=document.getElementsByClassName('textcontenu')[i];
	divi.removeChild(divi.lastChild.previousSibling);
	divi.childNodes[3].style.display="block";
